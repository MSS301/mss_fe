...
const PackageCard: React.FC<PackageCardProps> = ({
  ...
  const isPopular = Boolean((pkg as any).popular);

  return (
    <div
      className={`package-card ${isLoading ? "loading" : ""} ${
        isPopular ? "popular" : ""
      }`}
      style={{ animationDelay: `${index * 0.1}s` }}
    >
      <div className="package-header">
        {isPopular && <div className="package-badge">Phổ biến</div>}
        ...
        <div className="package-credits">
          ...
          {pkg.bonusCredits > 0 && (
            <div className="credits-item bonus">
              <div className="credits-item-left">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path
                    d="M10 2L12.5 7.5L18.5 8.5L14 12.5L15.5 18.5L10 15.5L4.5 18.5L6 12.5L1.5 8.5L7.5 7.5L10 2Z"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          <div className="credits-item total">
            <div className="credits-item-left">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
                  d="M10 1C5.58172 1 2 4.58172 2 9C2 13.4183 5.58172 17 10 17C14.4183 17 18 13.4183 18 9C18 4.58172 14.4183 1 10 1Z"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
      ...
      <div className="package-footer">
        <button
          className={`btn-select-package ${isPopular ? "popular" : ""}`}
          onClick={handleClick}
          disabled={isLoading}
        >
          {isLoading ? (
